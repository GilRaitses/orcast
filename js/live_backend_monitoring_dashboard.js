...
class ORCASTLiveBackendDashboard {
    constructor() {
        ...
        this.endpoints = {
            ...
            'ML Model Status': {
                url: '/api/ml/model/status',
                method: 'GET',
                category: 'ml',
                cost_per_request: 0.001
            },
            'Feature Importance': {
                url: '/api/ml/features/importance',
                method: 'GET',
                category: 'ml',
                cost_per_request: 0.001
            },
            ...
            'OrcaHello Detections': {
                url: '/api/orcahello/detections',
                method: 'GET',
                category: 'orcahello',
                cost_per_request: 0.015
            },
            'OrcaHello Status': {
                url: '/api/orcahello/status',
                method: 'GET',
                category: 'orcahello',
                cost_per_request: 0.002
            },
            'Live Hydrophones': {
                url: '/api/orcahello/hydrophones',
                method: 'GET',
                category: 'orcahello',
                cost_per_request: 0.005
            },
            ...
            // BigQuery Analytics
            'Recent Detections': {
                url: '/api/bigquery/recent_detections',
                method: 'GET',
                category: 'bigquery',
                cost_per_request: 0.020
            },
            'Active Hotspots': {
                url: '/api/bigquery/active_hotspots',
                method: 'GET',
                category: 'bigquery',
                cost_per_request: 0.025
            },
            'Top Routes': {
                url: '/api/bigquery/top_routes',
                method: 'GET',
                category: 'bigquery',
            ...
            // Environmental Data
            'Environmental Data': {
                url: '/api/environmental',
                method: 'GET',
                category: 'environmental',
                cost_per_request: 0.008
            },
            'NOAA Weather': {
                url: '/api/environmental/noaa/weather',
                method: 'GET',
                category: 'environmental',
                cost_per_request: 0.012
            },
            'Tidal Data': {
                url: '/api/environmental/noaa/tides',
                method: 'GET',
                category: 'environmental',
                cost_per_request: 0.010
            },
            ...
            'Route Recommendations': {
                url: '/api/routes/recommendations',
                method: 'GET',
                category: 'routes',
                cost_per_request: 0.015
            },
            'Google Maps Routes': {
                url: '/api/routes/google',
                method: 'POST',
                category: 'routes',
                cost_per_request: 0.005,
                payload: {
