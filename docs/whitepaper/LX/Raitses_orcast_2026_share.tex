% Raitses_orcast_2026_share.tex
% Content-only sharing version: abstract + body sections + references only.
% Excludes: Glossary_Content, Appendix_Diagrams.
...
\input{Sections/02_four_gaps}
\input{Sections/03_gate_bounded_honesty}
\input{Sections/04_acoustic_grounding}
\input{Sections/05_governance}
\input{Sections/06_provenance_system}
\input{Sections/07_agent_pipeline}
\input{Sections/08_geospatial_limits}
\input{Sections/09_limits_falsification}

\clearpage
\nocite{*}
\printbibliography[title={References}]

%% NOTE: Glossary and Appendix_Diagrams intentionally omitted in share version.
